...
var ajax = function ajax(paramObj, successCallback, errorCallback) {
  ...
  /**
   * 不传contentType 的时候，http请求走 url parameter
   * @param  {[type]} url    [description]
   * @param  {[type]} header [description]
   * @return {[type]}        [description]
   */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_api_ajax_js__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__index_css__ = __webpack_require__(692);
...
var CreateNewDynamic = function (_Component) {
    _inherits(CreateNewDynamic, _Component);

    function CreateNewDynamic(props) {
        _classCallCheck(this, CreateNewDynamic);

        var _this = _possibleConstructorReturn(this, (CreateNewDynamic.__proto__ || Object.getPrototypeOf(CreateNewDynamic)).call(this, props));
        ...
        _this.handlerChange = function (e) {
            var contentNum = e.target.value.length;
            _this.setState({
        ...
        _this.getParam = function () {
            _this.setState({
                ...
                dynamicId: summer.pageParam.dynamicId,
                commentor: summer.pageParam.commentor ? summer.pageParam.commentor : '',
                commentorName: summer.pageParam.commentorName ? summer.pageParam.commentorName : '',
                index: summer.pageParam.index
            });
        };

        _this.createNewComment = function (e) {
            if (_this.trimStr(_this.state.content) == '') {
                summer.toast({ msg: '说点什么吧' });
                return;
            }
            _this.postComment();
        };
        ...
        _this.state = {
            ...
            commentorName: '',
            index: '', //点击动态的索引值
            contentNum: 0 //复选框内容的长度
        };
        return _this;
    }

    _createClass(CreateNewDynamic, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            //this.init();
            this.ready();
            window._comment = this;
        }
    }, {
        key: 'closeWin',
        ...
        value: function postComment() {
            ...
            if (self.state.type == 0) {
                param = {
                    "commentSrcType": 1,
                    "commentSrcId": self.state.dynamicId,
                    "comments": self.trimStr(self.state.content)
                };
            } else if (self.state.type == 1) {
                param = {
                    commentor: self.state.commentor,
                    "commentSrcType": 1,
                    "commentSrcId": self.state.dynamicId,
                    "comments": self.trimStr(self.state.content)
                };
            }
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_api_ajax_js__["a" /* ajax */])({
                type: 'post',
                url: '/dynamic/addComments',
                param: param,
                ...
                if (res.flag == 0) {
                    ...
                    var commentor = userinfo.id;
                    var commentItem = null;
                    if (self.state.type == 0) {
                        commentItem = {
                            "commentor": commentor,
                            "commentorName": userName,
                            "comments": self.state.content,
                            "id": res.data.id,
                            "index": self.state.index
                        };
                    } else if (self.state.type == 1) {
                        commentItem = {
                            "applyCommentorId": self.state.commentor,
                            "applyCommentorName": self.state.commentorName,
                            "commentor": commentor,
                            "commentorName": userName,
                            "comments": self.state.content,
                            "id": res.data.id,
                    ...
                    commentItem = JSON.stringify(commentItem);
                    summer.execScript({
                        winId: 'root',
                        script: "pub_commentS('" + commentItem + "')"
                    });
                    summer.closeWin();
                } else {
                    var message = res.msg ? res.msg : "接口出错";
                    summer.toast({ msg: message });
                }
            }, function (err) {
                summer.toast({ msg: '接口出错' });
            });
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'div',
                    { id: 'content', className: 'um-content' },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'div',
                        { className: 'textarea-box' },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('textarea', { maxLength: '240', className: 'dynamic-text', placeholder: '\u5199\u70B9\u4EC0\u4E48\u5427...', value: this.state.content, onChange: function onChange(e) {
    ...
    return CreateNewDynamic;
}(__WEBPACK_IMPORTED_MODULE_0_react__["Component"]);

__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(CreateNewDynamic, null), document.querySelector("#app"));
