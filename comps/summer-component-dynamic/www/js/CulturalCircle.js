  ...
  _createClass(CulturalSwiper, [{
    ...
    value: function render() {
      ...
      var params = {
        loop: true,
        autoplay: 1500,
        preventClicks: true, //此时手动滑动swiper不会跳转url
...
CulturalSwiper.propTypes = {
  interviewType: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.number.isRequired, //人物专访类型 1 全部 2 公司
  starType: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.number.isRequired //荣耀之星类型 1 全部 2 公司
};
        ...
        _this.getParam = function () {
            ...
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_api_ajax_js__["a" /* ajax */])({
                ...
                if (res.flag == 0) {
                    ...
                    var message = res.msg ? res.msg : '接口错误';
                    summer.toast({ msg: message });
                }
            }, function (err) {
                summer.toast({ msg: "接口错误" });
            });
        };
...
companySwiper.propTypes = {
    interview: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.number.isRequired //人物专访类型 1 全部 2 公司
};
...
HonourStar.propTypes = {
    star: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.number.isRequired //荣耀之星类型 1 全部 2 公司
};
...
var CulturalCircle = function (_Component) {
    ...
    function CulturalCircle(props) {
        ...
        _this.state = {
            listAllData: [], //全部数据
            likeList: [],
            showLike: false, //是否显示点赞组件
            commentList: [],
            showCommet: false, // 是否显示评论组件
            index: '', //添加评论对应的列表项
            isRefreshFooterAll: true, //是否还有下拉项
            allCount: 1 //下拉页数
        };
        ...
        value: function createNewDynamic() {
            summer.openWin({
                ...
                actionBar: {
                    ...
                    titleColor: "#333333",
                    backgroundColor: "#ffffff",
                    //            backgroundImg: "bac.png",//Android 请将图片配置到原生资源中
                    leftItem: {
                        image: "static/img/go_back.png",
                        method: ""
                    },
                    rightItems: [{
                        ...
                        text: "发送",
                        textColor: "#F96A74",
                        method: "_createNewDynamic.createNewDynamic()" //点击回调的方法
                    }]
                }
            });
        }
...
var CircleItem = function (_Component) {
            ...
            summer.openWin({
                ...
                actionBar: {
                    ...
                    rightItems: [{
                        ...
                        text: "发送",
                        textColor: "#F96A74",
                        method: "_comment.createNewComment()" //点击回调的方法
                    }]
                },
                pageParam: {
                    dynamicId: dynamicId,
                    type: 0, //0表示直接回复动态 1 回复用户
                    index: index //表示点击动态的索引值
                },
                animation: {
                    type: "movein",
                    subType: "from_bottom",
    ...
    _createClass(CircleItem, [{
        ...
        value: function formatDate2(dateTime) {
            ...
            var o = {
                month: d.getMonth() + 1, //月份
                day: d.getDate(), //日
                hour: d.getHours() < 10 ? '0' + d.getHours() : d.getHours(), //小时
                minute: d.getMinutes() < 10 ? '0' + d.getMinutes() : d.getMinutes() //分
            };
            var newDate = o.month + '月' + o.day + '日' + '  ' + o.hour + ':' + o.minute;
            return newDate;
        }
    }, {
        key: 'confirmDelete',
        ...
        value: function render() {
            ...
            var likeText = self.checkHasLike() ? '取消点赞' : '点赞';
...
CircleItem.propTypes = {
    itemData: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.object.isRequired, //动态列表数据
    likeList: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.array.isRequired, //点赞列表
    showLike: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.bool.isRequired, // 是否显示点赞列表
    commentList: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.array.isRequired, //评论列表
    showCommet: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.bool.isRequired, // 是否显示评论列表
    deleteDynamic: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.func.isRequired //删除自己创建的列表
};
    ...
    function DynamicComment(props) {
        ...
        _this.goComment = function (e) {
            ...
            if (commentor == userid) {
                param = {
                    dynamicId: dynamicId,
                    type: 0, //0表示直接回复动态 1 回复用户
                    index: _this.props.index //表示点击动态的索引值
                };
            } else {
                param = {
                    dynamicId: dynamicId,
                    commentor: commentor,
                    type: 1, //0表示直接回复动态 1 回复用户
        ...
        _this.deleteMyComment = function (e) {
            ...
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_api_ajax__["a" /* ajax */])({
                ...
                var message = err.error ? err.error : '接口出错';
                summer.toast({ msg: message });
            });
        };
