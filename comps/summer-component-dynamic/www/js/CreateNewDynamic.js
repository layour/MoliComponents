...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__index_css__ = __webpack_require__(693);
...
var CreateNewDynamic = function (_Component) {
    ...
    function CreateNewDynamic(props) {
        ...
        _this.createNewDynamic = function (e) {
            if (_this.trimStr(_this.state.content) == '') {
                summer.toast({ msg: '请输入内容' });
                return;
            }
            var self = _this;
            var param = {
                "msg": self.trimStr(_this.state.content)
            };
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_api_ajax_js__["a" /* ajax */])({
                ...
                if (res.flag == 0) {
                    ...
                    newDynamic = JSON.stringify(newDynamic);
                    summer.execScript({
                        winId: 'root',
                        script: "pub_addDynamic('" + newDynamic + "')"
                    });
                    summer.toast({ msg: '动态发表成功' });
                    summer.closeWin();
                } else {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('textarea', { maxLength: '240', className: 'dynamic-text', placeholder: '\u8BF7\u8F93\u5165\u5FC3\u60C5', value: this.state.content, onChange: function onChange(e) {
